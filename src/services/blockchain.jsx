import abi from '../abis/src/contracts/Crowdy.sol/Crowdy.json'
...
const structuredBackers = (backers) => backers.map((backer) => ({
...
const structuredProjects = (projects) => projects.map((project) => ({
...
export { connectWallet, isWalletConnected, createProject, loadProjects, loadProject, updateProject, deleteProject, backProject, getBackers, payoutProject }